...
frame.add_button("Syeda", toggle_face1, 100)
frame.add_button("Micah", toggle_face2, 100)
frame.add_button("Devesh", toggle_face3, 100)
frame.add_button("Towaf", toggle_face4, 100)
frame.add_button("All", toggle_face5, 100)
